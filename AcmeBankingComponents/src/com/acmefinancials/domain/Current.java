...
public class Current extends Account {
    ...
    @Override
    public void deposit(BigDecimal amount) throws BankingException {
        if (amount.doubleValue()<= 0) {
            throw new BankingException("Invalid deposit amount. Attempted to deposit " + amount.toPlainString());
        }
